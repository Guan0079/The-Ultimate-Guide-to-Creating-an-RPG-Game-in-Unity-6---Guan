...
public class Entity_Stats : MonoBehaviour
{
    ...
    public float GetElementalDamage(out ElementType element, float scaleFactor = 1)
    {
        ...
        float bonusElementalDamage = major.intelligence.GetValue();//每增加1點智慧，+1元素傷害
    ...
    public float GetElementalResistance(ElementType element)
    {
        ...
        float bonusResitance = major.intelligence.GetValue() * .5f; //每增加1點智慧，+0.5%魔法抗性
        ...
        float resistance = baseResistance + bonusResitance;
        float resistanceCap = 75f;//抗性最高到75%
        float finalResistance = Mathf.Clamp(resistance, 0, resistanceCap) / 100;//轉變數值為0-1之間的乘數
    ...
    public float GetPhyiscalDamage(out bool isCrit, float scaleFactor = 1)
    {
        ...
        float bonusCritChance = major.agility.GetValue() * .3f; //每增加1點敏捷，+0.3%爆擊率
        float CritChance = baseCritChance + bonusCritChance;

        float baseCritPower = offense.critPower.GetValue();
        float bonusCritPower = major.strength.GetValue() * .5f; //每增加1點力量，+0.5%爆擊傷害
        float critPower = (baseCritPower + bonusCritPower) / 100; //總爆擊傷害的乘數 (舉例: 150 / 100 = 1.5f - 乘數百分比)
    ...
    public float GetArmorMitigation(float armorReduction)
    {
        ...
        float bonusArmor = major.vitality.GetValue();//每增加1點活力，增加1點護甲
        ...
        float mitigationCap = .85f; //減傷最高85%
    ...
    {
        float finalReduction = offense.armorReduction.GetValue() / 100; //總護甲減免的乘數 (舉例: 30 / 100 = 0.3f - 乘數百分比)(穿透對方的護甲防禦，趴數越高，對方的護甲越沒用)
    ...
    public float GetEvasion()
    {
        ...
        float bonusEvasion = major.agility.GetValue() * .5f; //每增加1點敏捷，增加0.5%的迴避率

        float totalEvasion = baseEvasion + bonusEvasion;
        float evasionCap = 85f; //迴避率最高只能到85%

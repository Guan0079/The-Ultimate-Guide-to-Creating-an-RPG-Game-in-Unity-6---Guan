...
public class Player : Entity
{
    ...
    [Range(0, 1)]
    public float inAirMoveMultiplier = .7f; //此數值應該只能介於「0和1」之間。
    [Range(0, 1)]
    public float wallSlideSlowMultplier = .7f;
    [Space]
    ...
    public void EnterAttackStateWithDelay()
    {
        ...
        queuedAttackCo = StartCoroutine(EnterAttackStateWuthDelayCo());
    }

    private IEnumerator EnterAttackStateWuthDelayCo()
    {
    ...
    private void OnEnable()
    {
        ...
        input.Player.Spell.performed += ctx => skillManager.shard.TryUsedSkill();
    }
